...
import HandPanRealmBuilderMode from "./handPanRealmBuilderMode2.js";
...
const modes = new Map([
    ['draggingObject', new DraggingObjectRealmBuilderMode({realmBuilder: this})],
   ['editingItem', new EditingItemRealmBuilderMode({realmBuilder: this})],

    ['handpan', new HandPanRealmBuilderMode({realmBuilder: this})],
    ['loadScreen', new LoadScreenRealmBuilderMode({realmBuilder: this})],
   ['mapScreen', new MapScreenRealmBuilderMode({realmBuilder: this})],
    ['normal', new NormalRealmBuilderMode({realmBuilder: this})],
    ['orbit', new OrbitRealmBuilderMode({realmBuilder: this})],
    // ['some future mode', new SomeFutureMode({realmBuilder: this})]
    // ['some future mode 2', new SomeFutureMode2({realmBuilder: this})]
])
