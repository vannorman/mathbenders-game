/*
### PLAYCANVAS INITIALIZER
- loads the playcanvas engine and dependencies incl. wasm, ammo, and draco (for compression, not used currently) 
- String of events (dislike) starting from document.ready
- TODO: ?Combine all "load game" functions into one function e.g. GameLoadFunctions = [LoadFirst().then(loadNext()).then.(loadNext())]..
*/
...
$(document).ready(function(){
    ...
    LoadEngine(canvas); // string 1
});

function LoadEngine(canvas,deviceType,pcx,data={}) {
...
function LoadScene() {
    ...
    const gfxOptions = {
        deviceTypes: [deviceType],
            // Eyton mentioned these, 
            // I thought they weren't used, commented them and the game still works? Perhaps a needed middleware for other devices? 
...
var canvasOffset = {top:0,left:0}; // Inventory.js and other ui will depend on this const
